...
function systemPrompt(offered: Slot[]) {
  ...
  return [
    ...
    "- Never offer a time that is not on the list above, and never say a time is booked. If the day they asked for is not there, offer what is and say so plainly.",
